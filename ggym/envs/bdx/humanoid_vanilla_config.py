...
class HumanoidVanillaCfg(LeggedRobotCfg):
    ...
    class terrain(LeggedRobotCfg.terrain):
        ...
        terrain_proportions = [0.0, 0.5, 0.0, 0.0, 0.0, 0.5, 0.0]
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = {
            ...
            "02_right_hip_abad": 0.0,
            "03_right_hip_pitch": -0.2,
            "04_right_knee": 0.6,
            "05_right_ankle": 0.0,
            "06_left_hip_yaw": 0.0,
            "07_left_hip_abad": 0.0,
    ...
    class control(LeggedRobotCfg.control):
        ...
        damping = {
            "01_right_hip_yaw": 3.0,
            "02_right_hip_abad": 3.0,
            "03_right_hip_pitch": 3.0,
            "04_right_knee": 3.0,
            "05_right_ankle": 3.0,
            "06_left_hip_yaw": 3.0,
            "07_left_hip_abad": 3.0,
            "08_left_hip_pitch": 3.0,
            "09_left_knee": 3.0,
            "10_left_ankle": 3.0,
        }
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        class ranges:
            ...
            lin_vel_y = 2.0  # 2. # 1.5   # min max [m/s]
