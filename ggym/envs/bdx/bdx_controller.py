...
from ggym.envs.bdx.bdx_controller_config import BdxControllerCfg
...
from ggym.utils import XCoMKeyboardInterface
from .jacobian import apply_coupling
from scipy.signal import correlate
import torch.nn.functional as F


class BdxController(LeggedRobot):
    cfg: BdxControllerCfg
    ...
    def _init_buffers(self):
        ...
        print(self.rigid_body_idx)
        self.right_hip_pos = self.rigid_body_state[
            :, self.rigid_body_idx["right_hip_pitch_roll_module"], :3
        ]
        self.left_hip_pos = self.rigid_body_state[
            :, self.rigid_body_idx["left_hip_pitch_roll_module"], :3
        ]
    ...
    def check_termination(self):
        ...
        self.terminated |= torch.any(self.base_pos[:, 2:3] < 0.05, dim=1)
